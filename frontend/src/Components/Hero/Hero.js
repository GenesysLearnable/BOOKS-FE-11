  ...
  /* <div className='Book-details'> 
    ...
    <h3>Continue Reading</h3>
        <div className='continue-reading-row'>
            ...
            <div className='Wrapping'>
                    <img style={{width: '171px', height: '200px'}} src={book1} alt='b00k1-pic' className='book-list' />

                  <div className='book-text'>
                  <p>
                  <h5 className='long-name'>Joanne Willey, Linda Sherwood, and Christopher J. Woolverton</h5>
                  <h4 className='course'>Microbiology</h4>
                  <p className='rate'>Page 267 <span>of 3,563</span>&nbsp; 1%</p>

                  <div className='Reading-rate'>
                  <img style={{width: '171', height: '12px', boarderRaduis: '12px'}} src={Rectangle} alt='continue reading' className='continue' />
                  <img style={{width: '11', height: '12px', boarderRaduis: '12px'}} src={greendot} alt='continue reading'  className='greendot' />
                  </div>
              </p>
          </div>
          </div> 
          ...
          <div className='Wrapping'>
                    <img style={{width: '171px', height: '200px'}} src={book2} alt='b00k1-pic' className='book-list' />
                  ...
                  <p className='rate-bk3'>Page 205<span> of 1,340</span>&nbsp; 20%</p>
          ...
          <div className='Wrapping'>
                    <img style={{width: '171px', height: '200px'}} src={book3} alt='b00k1-pic' className='book-list' />

                  <div className='book-text'>
                  <p>
                  <h5 className='long-name'>Bruce Alberts, Alexander Johnson, Julian Lewis, David Morgan, Martin Raff, Keith Roberts, and Peter Walter</h5>
        ...
        <h3>Category <button className='category-filter'>
          ...
          <div className='category-books'>
          <div className='center-book'>
          <img style={{width: '137.6px', height: '160px', top: '44px', left: '66px', justifyContent: 'center', alignItems: 'center', display: 'flex', border: '1px solid green'}} src={book3} alt='b00k1-pic' />
          </div>
      
        <p>
          <h2>Essential Cell Biology</h2>
          <h2><span>Bruce Alberts</span></h2>
          <button>Science</button>
          <button>Microbiology</button> <br/>
          <button>MCB 206</button>
        </p>
        ...
        <p>
          ...
          <h3>Community<button className='category-filter'>
          <img src={filterbutton} alt='icon'className='filter-icon' /> Filter</button></h3>
...
>>>>>>> 244066c1bd05c211b432d0e60a7caa4e7a6c1715
            </div>
